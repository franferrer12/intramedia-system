                  ...
                  <>
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors opacity-50 cursor-not-allowed"
                        disabled
                      >
